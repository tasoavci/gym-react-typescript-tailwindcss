      ...
      >
        ...
        >
          ...
          <p className="my-5">
            ...
            possimus omnis necessitatibus, aperiam amet soluta veritatis
            dignissimos magnam labore sed facilis! Ipsam cupiditate voluptatum
            doloribus assumenda minus, odio ab!
          </p>
        </motion.div>
        {/* FORM AND IMAGE*/}
        <div className="mt-10 justify-between gap-10 md:flex">
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                className="hover:text-whtie mt-5 rounded-lg bg-secondary-500 px-20 py-3 transition duration-500"
              >
                SUBMIT
              </button>
            </form>
